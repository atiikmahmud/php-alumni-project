...
<!-- end navbar -->
    ...
    <div class="user p-5">
        <div class="member-header border border-success rounded ">
            <h1 class="text-uppercase text-center text-danger">edit user profile</h1>
        </div>
    </div>
    ...
    <div class="container">
        <form method="post" action="users_edit.php?uid=<?php echo $id; ?>" enctype="multipart/form-data">
            <div class="form-row">
    ...
    <?php
                                        ...
                                        if(isset($_POST["update_profile"])) {
                                            ...
                                            if (!empty($name) || !empty($email) || !empty($gender) || !empty($district) || !empty($prjs) || !empty($ptjs) || !empty($mobile) || !empty($birthdate)) {
                                                ...
                                                $query = "UPDATE users SET name ='$name', gender ='$gender', birthdate ='$birthdate', district ='$district', prjs ='$prjs', ptjs ='$ptjs', mobile ='$mobile', email ='$email' WHERE id = '$id'";
                                                $result = mysqli_query($con,$query);
                                                if ($result) {
