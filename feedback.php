...
<!-- end navbar -->
    ...
    <div class="user p-5">
        <div class="member-header border border-success rounded ">
            <h1 class="text-uppercase text-center text-danger">give your feedbak to admin</h1>
        </div>
    </div>
...
<form method="post" action="feedback_file.php" class="form-horizontal" enctype="multipart/form-data">
...
<div class="form-group">
    ...
    <div class="col-sm-10">
    <textarea class="form-control" rows="5" name="feedbackdata"></textarea>
    </div>
</div>
