    <header>
        <h1 class="text-uppercase text-center p-2">CSE ALUMNI ASSOCIATION OF VARENDRA UNIVERSITY</h1>
    </header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="home.php?ref=Home">Home</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="view_notice.php?ref=Notification">Notification</a>
                </li>
        ...
        <form class="form-inline">
            <?php  
                            ...
                            <?php }else{ ?>
                            <img src="images/uploads/<?php echo $image; ?>" alt="" height="40px" width="40px" class="rounded-circle mr-2"><b><?php echo $name; ?></b>
                            <?php } ?>
  </form>
    </nav>