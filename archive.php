...
<!-- end navbar -->
    ...
    <div class="user p-5">
        <div class="member-header border border-success rounded ">
            <h1 class="text-uppercase text-center text-danger">archive your files</h1>
        </div>
    </div>
...
<form method="post" action="archive_file.php" class="form-horizontal" enctype="multipart/form-data">
